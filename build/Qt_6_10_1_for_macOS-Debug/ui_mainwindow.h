...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/icons/Copilot_20251225_110941.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/icons/database-svgrepo-com-3.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionOpen_Database_2->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/icons/database-svgrepo-com.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSave_Changes->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/icons/database-svgrepo-com-2.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionClose_Database->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/new/icons/chart-svgrepo-com.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionCharts_Trends->setIcon(icon4);
        actionCharts_Trends->setMenuRole(QAction::MenuRole::NoRole);
        actionAbout = new QAction(MainWindow);
        actionAbout->setObjectName("actionAbout");
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/new/icons/info-svgrepo-com.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Weight Dashboard v0", nullptr));
